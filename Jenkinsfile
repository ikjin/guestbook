...
pipeline {
    ...
    environment {
        ...
        strDockerImage ="ikjin89/cicd_guestbook:${strDockerTag}"
    }
        ...
        stage('Checkout') {
            steps {
                ...
                dir('/root/sub-workspace/guestbook-config'){
                    git branch: 'master', url:'https://github.com/ikjin/guestbook-config.git'
                }
            }
        }
            ...
            steps {
                dir('/root/sub-workspace/guestbook-config'){
                    sh '''
                        ...
                        git push "https://ikjin:${GITHUB_ACCESS_TOKEN}@github.com/ikjin/guestbook-config.git"
                    '''
                }
            }
        }
